        ...
        <Row>
                        ...
                        {cartItems.map(item => (
                          <ListGroup.Item key={item.product}>
                              <Row>
                                ...
                                <Col md={3}>
                                <Form.Control as="select" size="sm" value={item.quantity} onChange={(e)=>dispatch(addToCart(item.product, Number(e.target.value)))}>
                                      {
            ...
            <Col md={4} >
                <Card>
                  <ListGroup variant="flush">
                    <ListGroup.Item>
                        <h2>Sub Total ({cartItems.reduce((acc, item)=> acc + Number(item.quantity),0)}) items</h2>
